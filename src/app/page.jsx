  ...
  return (
    <div className=" flex flex-col justify-center items-center w-full md:p-4 md:pt-10 h-screen">
      ...
      <div className="flex flex-col justify-center items-center px-32 md:px-0">
        ...
        <AnimatedText className="text-white w-[500px] text-center font-bold text-xl md:text-sm md:my-10"
        ...
        <motion.a
          ...
          initial="initial"
          animate="animate"
          class="relative  md:w-[70%] px-6 py-2 group mt-20 md:mt-10 md:mb-10 text-center"
        >
